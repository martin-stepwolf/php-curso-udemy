<?php session_start();
//este archivo es muy importante, se encargara de hacer todas las validaciones
// aqui trabajaremos con sesiones
...
//estas variables las recibimos de registrare.view.php
...
// 	$usuario = stripslashes($usuario);
	...
	if (empty($usuario) or empty($password) or empty($password2)) {
		...
		$statement = $conexion->prepare('SELECT * FROM usuarios WHERE usuario = :usuario LIMIT 1');// limit 1 por seguridad
